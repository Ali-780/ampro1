...
import { LogOut, RefreshCw, Users, Database, Clock, Key, Plus } from 'lucide-react';
...
export function Dashboard({ timeLeft, onLogout }: DashboardProps) {
  const {
    licenses,
    loading,
    stats,
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs opacity-80">التحكم الكامل</p>
              </div>
            </div>
